...
public class MathTutorFrame extends JFrame {
	...
	public MathTutorFrame() {
						...
						.addContainerGap().addGroup(groupLayout
								.createParallelGroup(Alignment.LEADING).addGroup(groupLayout.createSequentialGroup()
										.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
												.addComponent(lblDifficulty).addComponent(cmbDifficulty,
														GroupLayout.PREFERRED_SIZE, 142, GroupLayout.PREFERRED_SIZE))
										.addGap(18)
										.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
												.addComponent(lblOperator).addComponent(cmbOperator,
														GroupLayout.PREFERRED_SIZE, 188, GroupLayout.PREFERRED_SIZE)))
								.addComponent(panelCheck, GroupLayout.PREFERRED_SIZE,
										GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
								.addGroup(
										groupLayout.createParallelGroup(Alignment.TRAILING, false)
												.addComponent(panel, Alignment.LEADING, GroupLayout.PREFERRED_SIZE, 320,
												...
												.addGroup(groupLayout.createSequentialGroup()
														...
														.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
																.addComponent(btnEnterAnswer, GroupLayout.DEFAULT_SIZE,
																		GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
																.addComponent(txtAnswer, GroupLayout.DEFAULT_SIZE, 160,
																		Short.MAX_VALUE))))
								.addComponent(lblSolveThisProblem, GroupLayout.DEFAULT_SIZE, 361, Short.MAX_VALUE))
						.addPreferredGap(ComponentPlacement.RELATED)
						.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
								.addGroup(groupLayout.createSequentialGroup()
										.addPreferredGap(ComponentPlacement.RELATED).addComponent(lblHistory,
												GroupLayout.DEFAULT_SIZE, 257, Short.MAX_VALUE))
								.addGroup(groupLayout.createSequentialGroup().addGap(14).addComponent(scrollPane,
										GroupLayout.PREFERRED_SIZE, 249, GroupLayout.PREFERRED_SIZE)))
						.addContainerGap()));
		groupLayout.setVerticalGroup(groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup().addContainerGap()
						.addGroup(groupLayout.createParallelGroup(Alignment.LEADING).addComponent(lblDifficulty)
								.addGroup(groupLayout.createParallelGroup(Alignment.BASELINE)
										.addComponent(lblOperator, GroupLayout.PREFERRED_SIZE, 22,
												GroupLayout.PREFERRED_SIZE)
						...
						.addGroup(groupLayout.createParallelGroup(Alignment.BASELINE)
								...
								.addGroup(groupLayout.createSequentialGroup()
										.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
												.addComponent(cmbOperator, GroupLayout.PREFERRED_SIZE,
														GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
												.addComponent(cmbDifficulty, GroupLayout.PREFERRED_SIZE,
														GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
										.addPreferredGap(ComponentPlacement.RELATED).addComponent(lblSolveThisProblem)
										.addPreferredGap(ComponentPlacement.RELATED)
										...
										.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
												.addGroup(groupLayout.createSequentialGroup()
														.addComponent(txtAnswer, GroupLayout.PREFERRED_SIZE,
																GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
														.addGap(11).addComponent(btnEnterAnswer))
		...
		gl_panelCheck.setHorizontalGroup(gl_panelCheck.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_panelCheck.createSequentialGroup().addContainerGap()
						.addGroup(gl_panelCheck.createParallelGroup(Alignment.TRAILING)
								.addComponent(lblRightWrong, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 331,
										Short.MAX_VALUE)
								.addComponent(btnNextQuestion, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 331,
										Short.MAX_VALUE))
						.addContainerGap()));
		gl_panelCheck.setVerticalGroup(gl_panelCheck.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_panelCheck.createSequentialGroup().addContainerGap()
		...
		gl_panel.setHorizontalGroup(gl_panel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel.createSequentialGroup().addContainerGap()
						.addComponent(lblProblem, GroupLayout.DEFAULT_SIZE, 243, Short.MAX_VALUE).addContainerGap()));
		gl_panel.setVerticalGroup(gl_panel.createParallelGroup(Alignment.LEADING).addGroup(Alignment.TRAILING,
				gl_panel.createSequentialGroup().addGap(5)
						.addComponent(lblProblem, GroupLayout.DEFAULT_SIZE, 61, Short.MAX_VALUE).addContainerGap()));
